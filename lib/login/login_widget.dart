...
class _LoginWidgetState extends State<LoginWidget> {
  ...
  void initState() {
    super.initState();
    textController1 = TextEditingController(text: 'headmanager@gmail.com');
    textController2 = TextEditingController(text: 'headmanager');
